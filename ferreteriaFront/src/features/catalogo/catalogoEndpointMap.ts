...
const mapa: Mapa = {
	...
	formas_pago: {
		...
		campo: {
			...
			forma_pago_sat: "formaPagoSatClave",
		...
		campoInverso: {
			...
			formaPagoSatClave: "forma_pago_sat",
	...
	usos_cfdi: {
		...
		campo: {
			clave: "clave",
			descripcion: "descripcion",
			aplica_fisica: "aplicaFisica",
			aplica_moral: "aplicaMoral",
			activo: "activo",
		},
		campoInverso: {
			clave: "clave",
			descripcion: "descripcion",
			aplicaFisica: "aplica_fisica",
			aplicaMoral: "aplica_moral",
			activo: "activo",
		},
	},
	formas_pago_sat: {
...
export function clavePayloadADTO(
	clave: string,
