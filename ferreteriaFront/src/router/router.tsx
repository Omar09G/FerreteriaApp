...
const VentasTotalesPage = lazy(() => import('@/features/reportes/VentasTotalesPage'))
const TopProductosPage = lazy(() => import('@/features/reportes/TopProductosPage'))
const MejoresDiasPage = lazy(() => import('@/features/reportes/MejoresDiasPage'))
const MejoresClientesPage = lazy(() => import('@/features/reportes/MejoresClientesPage'))
const MejoresVendedoresPage = lazy(() => import('@/features/reportes/MejoresVendedoresPage'))
const CierreDiarioPage = lazy(() => import('@/features/reportes/CierreDiarioPage'))
const ReportesIndexPage = lazy(() => import('@/features/reportes/ReportesIndexPage'))
const MovimientosPage = lazy(() => import('@/features/inventario/MovimientosPage'))
...
const CuentasPagarPage = lazy(() => import('@/features/compras/CuentasPagarPage'))
...
const DevolucionesPage = lazy(() => import('@/features/ventas/DevolucionesPage'))
    ...
    children: [
      {
        ...
        children: [
          ...
          { path: 'dashboard', element: <Suspense fallback={spinners.full}><DashboardPage /></Suspense> },
          {
            path: 'pos',
            element: pos(['VENDEDOR', 'ENCARGADO_CAJA', 'GERENTE', 'ADMINISTRADOR'], <Suspense fallback={spinners.full}><PosPage /></Suspense>),
          },
          ...
          { path: 'inventario', children: [
            ...
            { path: 'movimientos', element: <Suspense fallback={spinners.full}><MovimientosPage /></Suspense> },
            { path: 'traslados', element: <Suspense fallback={spinners.full}><TrasladosPage /></Suspense> },
            { path: 'conteos', element: <Suspense fallback={spinners.full}><ConteosPage /></Suspense> },
          ]},
          { path: 'compras', children: [
            { path: 'proveedores', element: <Suspense fallback={spinners.full}><ProveedoresPage /></Suspense> },
            { path: 'compras', element: <Suspense fallback={spinners.full}><ComprasPage /></Suspense> },
          ...
          { path: 'ventas', children: [
            ...
            { path: 'devoluciones', element: <Suspense fallback={spinners.full}><DevolucionesPage /></Suspense> },
          ]},
          { path: 'caja', children: [
          ...
          { path: 'rrhh', children: [
            { path: 'empleados', element: pos(['ADMINISTRADOR'], <Suspense fallback={spinners.full}><EmpleadosPage /></Suspense>) },
            { path: 'nomina', element: pos(['ADMINISTRADOR'], <Suspense fallback={spinners.full}><NominaPage /></Suspense>) },
          ]},
          ...
          { path: 'reportes', children: [
            { index: true, element: <Suspense fallback={spinners.full}><ReportesIndexPage /></Suspense> },
            { path: 'ventas-totales', element: <Suspense fallback={spinners.full}><VentasTotalesPage /></Suspense> },
            { path: 'horas-pico', element: <Suspense fallback={spinners.full}><HorasPicoPage /></Suspense> },
            { path: 'mejores-dias', element: <Suspense fallback={spinners.full}><MejoresDiasPage /></Suspense> },
            { path: 'top-productos', element: <Suspense fallback={spinners.full}><TopProductosPage /></Suspense> },
            { path: 'mejores-clientes', element: <Suspense fallback={spinners.full}><MejoresClientesPage /></Suspense> },
            { path: 'mejores-vendedores', element: <Suspense fallback={spinners.full}><MejoresVendedoresPage /></Suspense> },
            { path: 'cierre-diario', element: <Suspense fallback={spinners.full}><CierreDiarioPage /></Suspense> },
          ]},
