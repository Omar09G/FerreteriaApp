...
export function rangoFechas(fechaInicio?: string | null, fechaFin?: string | null): RangoFechas {
...
export function construirPreset(id: string): RangoFechas {
  ...
  switch (id) {
    ...
    case 'mes': {
      return { inicio: `${hoy.getFullYear()}-${String(hoy.getMonth() + 1).padStart(2, '0')}-01`, fin: hoyLocal() }
    }
    default:
