...
const GRUPOS: { clave: string; items: Item[] }[] = [
	{
		...
		items: [
			...
			},
			{
				...
				roles: ["VENDEDOR", "ENCARGADO_CAJA", "GERENTE", "ADMINISTRADOR"],
			},
		],
	},
	{
		...
		items: [
			{
				clave: "productos",
				a: "/catalogo/productos",
				icono: <Boxes className="h-4 w-4" />,
			},
			{
				clave: "clientes",
				a: "/catalogo/clientes",
				icono: <Users2 className="h-4 w-4" />,
			},
			{
				clave: "promociones",
				a: "/catalogo/promociones",
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				icono: <CalendarCheck2 className="h-4 w-4" />,
			},
			{
				clave: "traslados",
				a: "/inventario/traslados",
				icono: <HardHat className="h-4 w-4" />,
			},
			{
				clave: "conteos",
				a: "/inventario/conteos",
				icono: <Boxes className="h-4 w-4" />,
			},
		],
	},
	{
		...
		items: [
			...
			{
				clave: "devoluciones",
				a: "/ventas/devoluciones",
				icono: <Undo2 className="h-4 w-4" />,
			},
			{
				clave: "compras",
				a: "/compras/compras",
	...
	},
	{
		...
		items: [
			...
			{
				clave: "usuarios",
				a: "/seguridad/usuarios",
				icono: <UserCog className="h-4 w-4" />,
				roles: ["ADMINISTRADOR"],
			},
			{
				clave: "roles",
...
function CambiarPasswordDialog({
	...
	return (
		...
		>
			{open && (
				<CambiarPasswordForm onExito={() => undefined} onClose={onClose} />
			)}
		</Dialog>
	);
}
...
function SidebarNav() {
	...
	return (
		<nav
			aria-label={t("appshell.navegacion")}
