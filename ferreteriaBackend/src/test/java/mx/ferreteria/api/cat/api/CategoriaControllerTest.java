...
class CategoriaControllerTest {
        ...
        void list_returns200WithEnvelope() throws Exception {
                CategoriaResponse r1 = new CategoriaResponse(1, "Ferreteria", null, "/Ferreteria", (short) 0,
                                List.of());
                CategoriaResponse r2 = new CategoriaResponse(2, "Herramientas", null, "/Herramientas", (short) 0,
                                List.of());
        ...
        void listTree_returns200() throws Exception {
                CategoriaResponse child = new CategoriaResponse(2, "Martillos", 1, "/Ferreteria/Martillos", (short) 1,
                                List.of());
                CategoriaResponse root = new CategoriaResponse(1, "Ferreteria", null, "/Ferreteria", (short) 0,
                                List.of(child));
        ...
        void getById_found() throws Exception {
                when(service.getById(1))
                                .thenReturn(new CategoriaResponse(1, "Ferreteria", null, "/Ferreteria", (short) 0,
                                                List.of()));
        ...
        void create_valid() throws Exception {
                when(service.create(any(CategoriaRequest.class)))
                                .thenReturn(new CategoriaResponse(10, "Nueva Categoria", null, "/Nueva Categoria",
                                                (short) 0, List.of()));
        ...
        void update_found() throws Exception {
                when(service.update(eq(1), any(CategoriaRequest.class)))
                                .thenReturn(new CategoriaResponse(1, "Actualizada", null, "/Actualizada", (short) 0,
                                                List.of()));
