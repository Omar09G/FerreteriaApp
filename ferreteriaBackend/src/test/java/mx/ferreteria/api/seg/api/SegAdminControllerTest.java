 ...
 */
@WebMvcTest(controllers = SegAdminController.class, excludeAutoConfiguration = SecurityAutoConfiguration.class)
...
class SegAdminControllerTest {
        ...
        private static final UsuarioResponse U = new UsuarioResponse(11, "cajero1", "cajero1@x.mx", 42, true,
