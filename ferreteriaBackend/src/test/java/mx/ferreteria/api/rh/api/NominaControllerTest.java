...
@WebMvcTest(controllers = NominaController.class,
        excludeAutoConfiguration = SecurityAutoConfiguration.class)
@AutoConfigureMockMvc(addFilters = false)
@Import({DbErrorTranslator.class, NominaControllerTest.SliceConfig.class})
    ...
    private NominaResponse sampleResponse(String estado) {
        return new NominaResponse(
                ...
                estado, "PAGADA".equals(estado)
                        ? Instant.parse("2026-01-16T10:00:00Z") : null,
                1, "Quincena 1");
    }
