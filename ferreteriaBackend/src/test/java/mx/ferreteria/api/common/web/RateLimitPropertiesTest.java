...
class RateLimitPropertiesTest {
    ...
    void sinGruposCaeAFallbackInterno() {
        RateLimitProperties props = new RateLimitProperties(true, true, 100L, 5L, false /*distributed*/, false /*trustForwardedFor*/, null /*redisUri*/, null);
    ...
    void mapaVacioCaeAFallbackInterno() {
        RateLimitProperties props = new RateLimitProperties(true, true, 100L, 5L, false /*distributed*/, false /*trustForwardedFor*/, null /*redisUri*/, Map.of());
    ...
    void perfilExactoResuelto() {
        ...
        RateLimitProperties props = new RateLimitProperties(true, true, 100L, 5L, false /*distributed*/, false /*trustForwardedFor*/, null /*redisUri*/, grupos);
