...
@WebMvcTest(controllers = CajaController.class, excludeAutoConfiguration = SecurityAutoConfiguration.class)
@AutoConfigureMockMvc(addFilters = false)
@Import({ DbErrorTranslator.class, WebMvcTestProps.class, CajaControllerTest.SliceConfig.class })
...
class CajaControllerTest {
        ...
        void cerrarTurno_ok() throws Exception {
                CorteCajaResponse resp = new CorteCajaResponse(
                                ...
                                "{}", "{}", "{}", null);
                when(service.cerrarTurno(1L,
                                new mx.ferreteria.api.fin.dto.FinDtos.CorteRequest(new BigDecimal("6160.00"), null)))
                                .thenReturn(resp);
