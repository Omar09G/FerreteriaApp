...
class MensajesSoloDesdeErrorCodeTest {
    ...
    private static final DescribedPredicate<JavaCall<?>> CON_STRING_LITERAL =
            new DescribedPredicate<>("constructor de ApiException con argumento String") {
                @Override
    ...
    @ArchTest
    static final ArchRule excepcionesSoloConErrorCode =
    ...
    @ArchTest
    static final ArchRule modulosSinCiclos =
            SlicesRuleDefinition.slices().matching("mx.ferreteria.api.(*)..")
